...
# Step 1: Copy and prepare the data
...
# Convert categorical region to dummy variables (drop first to avoid multicollinearity)
...
# Step 2: Fit Poisson regression using GLM
...
#
#| code-fold: true
# Create X_0 (iscustomer=0 for all) and X_1 (iscustomer=1 for all)
X_0 = X.copy()
X_1 = X.copy()
X_0['iscustomer'] = 0
X_1['iscustomer'] = 1

# Predict expected number of patents for each firm under both scenarios
y_pred_0 = poisson_results.predict(X_0)
y_pred_1 = poisson_results.predict(X_1)

# Calculate the average treatment effect of being a customer
